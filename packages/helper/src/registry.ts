import { buildctlProvider } from './providers/buildctl.js';
...
// tools that run on top of it (kubectl, crane, buildctl). New providers
// append here; consumers iterate `defaultProviders` rather than
// referencing individual exports so additions Just Work.
export const defaultProviders: Provider[] = [dockerProvider, kubectlProvider, craneProvider, buildctlProvider];
