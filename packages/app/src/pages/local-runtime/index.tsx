...
import { AlertTriangle, Bot, Check, Copy, Download, Loader2, Play, RefreshCw, X } from 'lucide-react';
...
import type { AgentAuthStatus, LocalPreflightCheck } from '@/lib/host';
...
//
// `WorkloadsPanel` left for ③ env-detail in I3 (now
// `pages/environments/workloads-panel.tsx`). This module still owns one
// surface that is MID-MIGRATION and rides along inside ② until its phase
// lands:
//   · `LaunchAgentButton` (agent launcher)  → ④ Agents in I4
// Exported and consumed by `pages/clusters/runtime-detail.tsx`.
